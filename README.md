...
Notion の「📋 AI 秘書」DB に溜まった未整理メモを、毎朝 LLM が読み解いて
...
[**📋 AI 秘書 DB テンプレートをワンクリック複製**](https://sulfuric-queen-bc2.notion.site/09a34a51a4b44d0ab6abafa05fd02443)
...
3. アプリ名は `AI 秘書 Organizer` など、表示された 16 文字をコピー
...
2. 「📋 AI 秘書 Daily Organize」ワークフローを選択
...
├── src/
│   ├── main.py                  # エントリポイント
│   ├── notion_secretary.py      # Notion API ラッパー
...
```bash
gh workflow disable "📋 AI 秘書 Daily Organize" --repo OWNER/REPO
# 再開:
gh workflow enable "📋 AI 秘書 Daily Organize" --repo OWNER/REPO
```
